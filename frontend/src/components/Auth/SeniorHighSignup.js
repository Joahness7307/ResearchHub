...
const SeniorHighSignup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Prepare data: Now includes confirm_password
    ...
    const dataToSend = { 
      ...
      confirm_password: form.confirm_password, // 🛑 FIX: Added back for server validation
    ...
    // These deletes are fine, as they prevent sending unnecessary fields
